...
<div className="min-h-screen flex flex-col items-center pt-16 pb-8 bg-gray-50 mx-auto px-6"> 

    {/* Registration Header Section */}
  <div className="flex flex-col items-start px-auto sm:pl-[0.3125rem] w-full max-w-[917px] rounded-lg z-10 mt-6 sm:mt-12">
  {/* Title and Subtitle */}
...
<div className="flex flex-col items-start p-4 sm:p-6 rounded-lg bg-white w-full max-w-[902px] mt-4 z-10 relative mx-auto px-8 sm:px-6 lg:px-8">
  {/* Section Title */}
